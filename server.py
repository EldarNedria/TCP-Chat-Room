    ...
    while True:
        try:
            ...
            if client in clients:
                ...
                broadcast(f'{nickname} left the chat!'.encode('ascii'))#why encode ascii????
...
def receive():
    while True:
        ...
        thread = threading.Thread(target=handle, args=(client,)) #explanation of line (Python threads. | Start not Run???)
        thread.start()
